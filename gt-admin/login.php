<?php session_start(); include $_SERVER['DOCUMENT_ROOT'] . "/gt-include.php"; ?>
<!DOCTYPE html>
<html>
<head>
            ...
            <form action="" method="post">
                ...
                if (isset($_POST['gt-login'])) {
					...
					if ($st == "no") {
						...
						$user = new user();
						$_SESSION['account_id'] = explode("|", $st)[0];
                        $_SESSION['user_id'] = $u_id = explode("|", $st)[1];
                        $_SESSION['name'] = $user->get_user_name($u_id);
                        $_SESSION['family'] = $user->get_user_family($u_id);
