<?php include "header.php"; $account_id = $_SESSION['account_id']; ?>
			...
			<div class="row">
				<div class="col-md-3 col-sm-6">
					...
					<select name="p_id" class="select2 form-control">
						<?php
						$items = get_select_query("select * from person where a_id = $account_id");
				...
				<div class="col-md-3 col-sm-6">
					...
					<select name="pr_id" class="select2 form-control">
						<?php
						$items = get_select_query("select * from product where a_id = $account_id");
						foreach($items as $item){
						?>
