...
--
-- Host: localhost    Database: helisoft_chikodb
-- ------------------------------------------------------
...
--
-- Current Database: `helisoft_chikodb`
--
...
CREATE TABLE `game_meta` (
  ...
  PRIMARY KEY (`gm_id`)
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 COMMENT='اطلاعات اضافی بازی';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `setting` (`ID`, `a_id`, `meta_key`, `meta_value`) VALUES (9,1,'opt_name','چیکولند'),(10,1,'opt_hour1','8000'),(11,1,'opt_hour2','8000'),(12,1,'save_opt',''),(13,1,'opt_home',''),(14,1,'sms_user','mahdavi1456'),(15,1,'sms_pass','m54692764o'),(16,1,'sms_line','+985000125475'),(25,14,'opt_name','چیکولند'),(26,14,'opt_home',''),(27,14,'opt_hour1','4000'),(28,14,'opt_hour2','4000'),(29,14,'sms_user','boardland'),(30,14,'sms_pass','123456'),(31,14,'sms_line','+985000125475'),(32,14,'save_opt',''),(33,23,'opt_name','چیکولند'),(34,23,'opt_home',''),(35,23,'opt_hour1','5000'),(36,23,'opt_hour2','3000'),(37,23,'sms_user',''),(38,23,'sms_pass',''),(39,23,'sms_line','-'),(40,23,'save_opt',''),(41,1,'happy_text','نوگول باغ زندگی \r\nتولدت مبارک\r\nگراتک'),(42,25,'opt_name','چیکولند'),(43,25,'opt_home',''),(44,25,'sms_user',''),(45,25,'sms_pass',''),(46,25,'sms_line','-'),(47,25,'happy_text','تولدت مبارک'),(48,25,'opt_hour1','5000'),(49,25,'opt_hour2','5000'),(50,25,'save_opt',''),(51,21,'opt_name','چیکولند'),(52,21,'opt_home',''),(53,21,'sms_user','9122753213'),(54,21,'sms_pass','خئهی30030'),(55,21,'sms_line','+981000152'),(56,21,'happy_text','سلام عزیزم\r\nتولد کوچولوی نازنینت\r\nمبارک\r\n\r\nدلتنگ ش'),(57,21,'opt_hour1','75000'),(58,21,'opt_hour2','60000'),(59,21,'save_opt',''),(60,22,'opt_name','چیکولند'),(61,22,'opt_home',''),(62,22,'sms_user','9122753213'),(63,22,'sms_pass','0453608167'),(64,22,'sms_line','+985000125475'),(65,22,'happy_text','فرشته كوچولو\r\nروز به دنيا اومدن تو براي همه ما عزیزه،\r\nبه مناسبت تولدت، امروز در خانه بازی بالونیا یک ساعت مهمان ما هستی عزیزم\r\nمنتظرت هستیم'),(66,22,'opt_hour1',''),(67,22,'opt_hour2',''),(68,22,'save_opt',''),(69,29,'opt_name','چیکولند'),(70,29,'opt_home',''),(71,29,'sms_user','09133933505'),(72,29,'sms_pass','soltani3505'),(73,29,'sms_line','+985000125475'),(74,29,'happy_text','تولدت مبارک\r\nخونه مادربزرگه'),(75,29,'opt_hour1','10000'),(76,29,'opt_hour2','10000'),(77,29,'save_opt',''),(78,33,'opt_name','چیکولند'),(79,33,'opt_home',''),(80,33,'sms_user',''),(81,33,'sms_pass',''),(82,33,'sms_line','-'),(83,33,'happy_text',''),(84,33,'opt_hour1','8000'),(85,33,'opt_hour2','8000'),(86,33,'save_opt',''),(87,1,'free_time','0'),(88,1,'price_1_to_15','60000'),(89,1,'price_15_to_30','60000'),(90,1,'price_30_to_45','60000'),(91,1,'price_45_to_60','60000'),(92,1,'price_up_60','14000'),(93,29,'free_time','0'),(94,29,'price_1_to_15','2500'),(95,29,'price_15_to_30','5000'),(96,29,'price_30_to_45','7500'),(97,29,'price_45_to_60','10000'),(98,29,'price_up_60','14000'),(99,25,'free_time','0'),(100,25,'price_1_to_15','1200'),(101,25,'price_15_to_30','1100'),(102,25,'price_30_to_45','1000'),(103,25,'price_45_to_60','900'),(104,25,'price_up_60','14000'),(105,29,'part_calc','0'),(106,1,'part_calc','1'),(107,22,'free_time','0'),(108,22,'part_calc','1'),(109,22,'price_1_to_15','60000'),(110,22,'price_15_to_30','60000'),(111,22,'price_30_to_45','60000'),(112,22,'price_45_to_60','60000'),(113,22,'price_up_60','14000'),(114,1,'login_price','0'),(115,1,'login_deadline','0'),(116,1,'baloon_round','1'),(117,22,'login_price','0'),(118,22,'login_deadline','0'),(119,22,'baloon_round','1'),(120,29,'login_price','0'),(121,29,'login_deadline','0'),(122,29,'baloon_round','0'),(123,22,'ppp','30'),(124,22,'price_vip','50000'),(125,15,'opt_name','چیکولند'),(126,15,'opt_home',''),(127,15,'ppp','30'),(128,15,'sms_user',''),(129,15,'sms_pass',''),(130,15,'sms_line','-'),(131,15,'happy_text',''),(132,15,'free_time','0'),(133,15,'login_price','0'),(134,15,'login_deadline','0'),(135,15,'part_calc','1'),(136,15,'price_up_60','14000'),(137,15,'price_vip','50000'),(138,15,'baloon_round','0'),(139,15,'save_opt',''),(140,1,'ppp','30'),(141,1,'price_vip','50000'),(142,29,'ppp','30'),(143,29,'price_vip','50000'),(144,1,'opt_address','-'),(145,1,'opt_sign','ممنون از اینکه به مجموعه ما سر زدید...'),(146,22,'opt_address','-'),(147,22,'opt_sign','ممنون از اینکه به مجموعه ما سر زدید...'),(148,0,'price_down_60','0'),(149,0,'price_down_vip',''),(150,0,'round_type','chiko'),(151,0,'vip_price_down_60','0'),(152,0,'vip_price_up_60','0');
...
--
-- Dumping events for database 'helisoft_chikodb'
--

--
-- Dumping routines for database 'helisoft_chikodb'
--
